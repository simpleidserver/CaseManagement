...
namespace CaseManagement.Gateway.Website.CasePlanInstance.QueryHandlers
{
    public class GetAssignedCasePlanInstanceQueryHandler : IGetAssignedCasePlanInstanceQueryHandler
    {
        ...
        public GetAssignedCasePlanInstanceQueryHandler(ICasePlanInstanceService casePlanInstanceService, IFormInstanceService formInstanceService, IFormService formService)
        {
        ...
        public async Task<GetCasePlanInstanceResult> Handle(GetAssignedCasePlanInstanceQuery query)
        {
            var casePlanInstance = await _casePlanInstanceService.GetMe(query.CasePlanInstanceId, query.IdentityToken);
