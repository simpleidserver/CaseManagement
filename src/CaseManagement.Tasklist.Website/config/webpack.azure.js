...
const API_URL = process.env.API_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/humantaskapi";
const CM_API_URL = process.env.CM_API_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/casemanagementapi";
const OPENID_URL = process.env.OPENID_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/openid";
const REDIRECT_URL = process.env.REDIRECT_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/tasklist";
...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            'CM_API_URL': JSON.stringify(CM_API_URL),
            'process.env': {
                'ENV': JSON.stringify(ENV),
                'API_URL': JSON.stringify(API_URL),
                'OPENID_URL': JSON.stringify(OPENID_URL),
