...
export class SearchCmmnPlans implements Action {
    ...
    constructor(public order: string, public direction: string, public count: number, public startIndex: number, public caseFileId: string, public takeLatest: boolean) { }
}
