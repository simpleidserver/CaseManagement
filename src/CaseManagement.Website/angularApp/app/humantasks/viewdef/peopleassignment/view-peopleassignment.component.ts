...
export class ViewTaskPeopleAssignmentComponent implements OnInit {
    ...
    constructor(
        ...
        this.actions$.pipe(
            ...
            .subscribe(() => {
                this.snackBar.open(this.translateService.instant('HUMANTASK.MESSAGES.PEOPLE_ASSIGNMENT_UPDATED'), this.translateService.instant('undo'), {
                    duration: 2000
                });
            });
        this.actions$.pipe(
            ...
            .subscribe(() => {
                this.snackBar.open(this.translateService.instant('HUMANTASK.MESSAGES.CANNOT_UPDATE_PEOPLE_ASSIGNMENT'), this.translateService.instant('undo'), {
                    duration: 2000
                });
            });
    }
