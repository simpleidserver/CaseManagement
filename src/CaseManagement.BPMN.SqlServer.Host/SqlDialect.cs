using CaseManagement.BPMN.SqlServer.Host.Resources;
using NEventStore;
...
{
    public class SqlDialect : CommonSqlDialect
    {
        ...
        public override string InitializeStorage
        {
            get 
            { 
                return SqlStatements.InitializeStorage; 
            }
        }
        ...
        {
            get { return SqlStatements.PersistCommit; }
        }
        ...
        private static string CommonTableExpressionPaging(string query)
        {
            ...
            string value = SqlStatements.PagedQueryFormat.FormatWith(select, orderBy, from);
            return value;
        }
        ...
        {
            if (Transaction.Current == null) return connection.BeginTransaction(IsolationLevel.ReadCommitted);
