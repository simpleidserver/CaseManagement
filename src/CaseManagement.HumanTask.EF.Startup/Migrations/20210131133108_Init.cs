    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationDefinitions", x => x.AggregateId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HumanTaskDefinitionAggregateAggregateId = table.Column<string>(nullable: true),
                    HumanTaskInstanceAggregateAggregateId = table.Column<string>(nullable: true),
                    NotificationDefinitionAggregateAggregateId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parameter_NotificationDefinitions_NotificationDefinitionAggregateAggregateId",
                        column: x => x.NotificationDefinitionAggregateAggregateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PeopleAssignmentDefinition_NotificationDefinitions_NotificationDefinitionAggregateAggregateId",
                        column: x => x.NotificationDefinitionAggregateAggregateId,
                        principalTable: "NotificationDefinitions",
                        principalColumn: "AggregateId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PresentationElementDefinition_NotificationDefinitions_NotificationDefinitionAggregateAggregateId",
                        column: x => x.NotificationDefinitionAggregateAggregateId,
                        principalTable: "NotificationDefinitions",
                        principalColumn: "AggregateId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PresentationParameter_NotificationDefinitions_NotificationDefinitionAggregateAggregateId",
                        column: x => x.NotificationDefinitionAggregateAggregateId,
                        principalTable: "NotificationDefinitions",
                        principalColumn: "AggregateId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parameter_NotificationDefinitionAggregateAggregateId",
                table: "Parameter",
                column: "NotificationDefinitionAggregateAggregateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PeopleAssignmentDefinition_NotificationDefinitionAggregateAggregateId",
                table: "PeopleAssignmentDefinition",
                column: "NotificationDefinitionAggregateAggregateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PresentationElementDefinition_NotificationDefinitionAggregateAggregateId",
                table: "PresentationElementDefinition",
                column: "NotificationDefinitionAggregateAggregateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PresentationParameter_NotificationDefinitionAggregateAggregateId",
                table: "PresentationParameter",
                column: "NotificationDefinitionAggregateAggregateId");
