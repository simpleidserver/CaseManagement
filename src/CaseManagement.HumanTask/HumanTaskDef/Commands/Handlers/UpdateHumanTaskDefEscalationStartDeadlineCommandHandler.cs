...
{
    public class UpdateHumanTaskDefEscalationStartDeadlineCommandHandler : IRequestHandler<UpdateHumanTaskDefEscalationStartDeadlineCommand, bool>
    {
        ...
        public UpdateHumanTaskDefEscalationStartDeadlineCommandHandler(
        ...
        public async Task<bool> Handle(UpdateHumanTaskDefEscalationStartDeadlineCommand request, CancellationToken cancellationToken)
        {
            ...
            result.UpdateEscalationStartDeadline(request.DeadLineId, request.EscalationId, request.Escalation.ToDomain());
            ...
            _logger.LogInformation("Escalation has been updated in the start deadline");
            return true;
        }
    }
}
