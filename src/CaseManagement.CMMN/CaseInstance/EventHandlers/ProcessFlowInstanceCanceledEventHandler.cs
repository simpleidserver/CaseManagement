...
{
    public class ProcessFlowInstanceCanceledEventHandler : IDomainEventHandler<ProcessFlowInstanceCanceledEvent>
    {
        ...
        public ProcessFlowInstanceCanceledEventHandler(IProcessFlowInstanceQueryRepository processFlowInstanceQueryRepository, IProcessFlowInstanceCommandRepository processFlowInstanceCommandRepository)
        {
        ...
        public async Task Handle(ProcessFlowInstanceCanceledEvent @event, CancellationToken token)
        {
