...
{
    public class ProcessFlowElementBlockedEventHandler : IDomainEventHandler<ProcessFlowElementBlockedEvent>
    {
        ...
        public ProcessFlowElementBlockedEventHandler(IProcessFlowInstanceQueryRepository processFlowInstanceQueryRepository, IProcessFlowInstanceCommandRepository processFlowInstanceCommandRepository)
        {
        ...
        public async Task Handle(ProcessFlowElementBlockedEvent @event, CancellationToken token)
        {
