...
{
    public class ProcessFlowInstanceVariableAddedEventHandler : IDomainEventHandler<ProcessFlowInstanceVariableAddedEvent>
    {
        ...
        public ProcessFlowInstanceVariableAddedEventHandler(IProcessFlowInstanceQueryRepository processFlowInstanceQueryRepository, IProcessFlowInstanceCommandRepository processFlowInstanceCommandRepository)
        {
        ...
        public async Task Handle(ProcessFlowInstanceVariableAddedEvent @event, CancellationToken token)
        {
