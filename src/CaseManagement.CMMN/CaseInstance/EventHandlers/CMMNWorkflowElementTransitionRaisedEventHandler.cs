...
{
    public class CMMNWorkflowElementTransitionRaisedEventHandler : IDomainEventHandler<CMMNWorkflowElementTransitionRaisedEvent>
    {
        ...
        public CMMNWorkflowElementTransitionRaisedEventHandler(ICMMNWorkflowInstanceCommandRepository cmmnWorkflowInstanceCommandRepository, ICMMNWorkflowInstanceQueryRepository cmmnWorkflowInstanceQueryRepository)
        {
