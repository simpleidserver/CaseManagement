...
namespace CaseManagement.CMMN.Domains.Events
{
    ...
    {
        public CMMNWorkflowElementCreatedEvent(string id, string aggregateId, int version, string elementId, string workflowElementDefinitionId, CMMNWorkflowElementTypes workflowElementDefinitionType, DateTime createDateTime, string parentId) : base(id, aggregateId, version)
        {
            ElementId = elementId;
