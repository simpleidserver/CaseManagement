...
namespace CaseManagement.CMMN.Domains.Events
{
    ...
    {
        public CaseWorkerTaskAddedEvent(string id, string aggregateId, int version, string performerRole, string casePlanInstanceId, string casePlanElementInstanceId, CaseWorkerTaskTypes taskType, DateTime createDateTime) : base(id, aggregateId, version)
        {
