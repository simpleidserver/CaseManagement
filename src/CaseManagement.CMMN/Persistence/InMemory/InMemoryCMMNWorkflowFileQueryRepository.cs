...
{
    public class InMemoryCMMNWorkflowFileQueryRepository : ICMMNWorkflowFileQueryRepository
    {
        ...
        public InMemoryCMMNWorkflowFileQueryRepository(ICollection<CaseFileDefinitionAggregate> caseFileDefinitions)
        {
