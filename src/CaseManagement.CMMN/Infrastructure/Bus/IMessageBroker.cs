...
namespace CaseManagement.CMMN.Infrastructure.Bus
{
    public interface IMessageBroker : IDisposable
    {
        ...
        /// <returns></returns>
        Task QueueScheduleMessage(string queueName, object msg, DateTime elapsedTime, CancellationToken token);
        /// <summary>
        /// Dequeue scheduled messages.
        /// </summary>
        /// <param name="token"></param>
        /// <returns></returns>
        Task<List<ScheduleMessage>> DequeueScheduleMessage(CancellationToken token);
        Task Start();
        Task Stop();
    }
}