...
namespace CaseManagement.CMMN.Tests
{
    public class CMMNParserFixture
    {
        ...
        public void When_Extract_WorkflowDefinitions()
        {
            ...
            var sixPath = Path.Combine(Directory.GetCurrentDirectory(), "Cmmns", "CaseWithOneHumanTaskAndRole.cmmn");
            ...
            var sixResult = CMMNParser.ExtractCasePlans(CMMNParser.ParseWSDL(File.ReadAllText(sixPath)), caseFile);
